                    ...
                    <div class="flex flex-col gap-5 py-5">
                        ...
                        <div class="flex items-end gap-3.5 px-5">
                            ...
                            <div class="flex flex-col gap-1.5">
                                <div class="card shadow-none flex flex-col bg-gray-100 gap-2.5 p-3 rounded-bl-none">
                                    <p class="text-2sm font-medium text-gray-700">
                                        I have looked over the rollout plan, and everything seems spot on. I am ready on
                                        my end and can not wait for the user feedback.
                                    </p>
                                </div>
                                <span class="text-2xs font-medium text-gray-500">
                                    15:09
                    ...
                    <div class="flex flex-col">
                        ...
                        <div class="menu-item px-4 py-1.5">
                            <form method="POST" @submit.prevent="logout">
                                <button class="btn btn-sm btn-danger justify-center w-full">
                                    Log out
                                </button>
                            </form>
                        </div>
