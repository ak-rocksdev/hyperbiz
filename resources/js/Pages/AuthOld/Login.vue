        ...
        <div class="card max-w-[370px] w-full">
            <form action="#" class="card-body flex flex-col gap-5 p-10" id="sign_in_form" method="get" @submit.prevent="submit">
                ...
                <div class="grid grid-cols-2 gap-2.5">
                    ...
                    <a class="btn btn-light btn-sm justify-center" href="#">
                        <img alt="apple-logo" class="size-3.5 shrink-0 dark:hidden" src="/assets/media/brand-logos/apple-black.svg"/>
                        <img alt="apple-logo" class="size-3.5 shrink-0 light:hidden" src="/assets/media/brand-logos/apple-white.svg"/>
                        Use Apple
                    </a>
                </div>
