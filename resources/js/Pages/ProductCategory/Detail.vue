...
<template>
    <AppLayout title="Category Detail">
        ...
        <div class="container-fixed py-5">
                ...
                <div class="card-body py-4">
                    <div class="flex flex-wrap items-center justify-between gap-4">
                        <div class="flex items-center gap-3">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-2 mt-1">
                                    ...
                                    <span v-if="category?.parent_name" class="badge badge-sm badge-outline badge-primary">
                        ...
                        <div class="flex flex-wrap gap-2">
                            <Link :href="`/product-category/edit/${category?.id}`" class="btn btn-sm btn-primary">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
                ...
                <div class="lg:col-span-2 space-y-5">
                            ...
                            <div class="grid grid-cols-2 md:grid-cols-3 gap-5">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900 dark:text-white">
                                        <Link v-if="category?.parent_id" :href="`/product-category/detail/${category.parent_id}`" class="text-primary hover:underline">
                                ...
                                <div>
                                    ...
                                    <p class="font-medium text-gray-900 dark:text-white">{{ formatDateTime(category?.created_at) }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div v-if="childCategories && childCategories.length > 0" class="card">
                        <div class="card-header">
                            <h3 class="card-title">
                        ...
                        <div class="card-body p-0">
                            <div class="scrollable-x-auto">
                                <table class="table table-auto table-border">
                                    ...
                                    <tbody>
                                        <tr v-for="child in childCategories" :key="child.id" class="hover:bg-slate-50 dark:hover:bg-coal-600">
                                            <td>
                                                <div class="flex items-center gap-3">
                                                    ...
                                                    <Link
                                                        :href="`/product-category/detail/${child.id}`"
                    ...
                    <div class="card">
                        <div class="card-header">
                            ...
                            <Link
                                v-if="category?.products_count > 10"
                                ...
                                <table class="table table-auto table-border">
                                    ...
                                    <tbody>
                                        <tr v-for="product in products" :key="product.id" class="hover:bg-slate-50 dark:hover:bg-coal-600">
                                            ...
                                            <td>
                                                <span v-if="product.brand_name !== '-'" class="badge badge-sm badge-outline badge-secondary">
                                                    {{ product.brand_name }}
                                                </span>
                ...
                <div class="space-y-5">
                        ...
                        <div class="card-body space-y-4">
                            ...
                            <div class="flex items-center gap-4 p-4 bg-gray-50 dark:bg-coal-500 rounded-xl">
                                <div class="flex items-center justify-center w-14 h-14 rounded-xl bg-info-light">
                                    <i class="ki-filled ki-element-11 text-info text-2xl"></i>
                                </div>
                                <div>
                                    <div class="text-2xl font-bold text-gray-900 dark:text-white">
                                        {{ childCategories?.length || 0 }}
                                    </div>
                                    <div class="text-sm text-gray-500">Child Categories</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-body space-y-3">
                            <!-- Edit Category -->
                            <Link :href="`/product-category/edit/${category?.id}`" class="btn btn-primary w-full">
